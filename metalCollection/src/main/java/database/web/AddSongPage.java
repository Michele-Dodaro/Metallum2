...
public class AddSongPage {
    ...
    public AddSongPage(SongRepository songRepository, BandRepository bandRepository, HomepageService homepageService, GenreRepository genreRepository, @Location("add.song.qute.html") Template addSongTemplate) {
